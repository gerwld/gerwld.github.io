...
export {default as ProjectItem} from './UI/ProjectItem';
export {default as SkillsItem} from './UI/SkillsItem';

export {default as ModalSetLang} from './modals/ModalSetLang';
