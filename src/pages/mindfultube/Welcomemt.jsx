...
import slide_1 from "@/assets/extensions/shots/MindfulTube/prev_1.png";
  ...
  return (
    <div className={s.landing_content + " " + s.landing_content__welcome}>
      ...
      <div className={s.w_header}>
        <div className={s.w_header__content}>
          <div className={s.header_group}>
            <h1 className={s.landing_title}>MindfulTube for Chrome Is Now Active!</h1>
          ...
          <div className={s.presentation}>
            ...
            <div className={s.pres_content}>
              <h3>The MindfulTube logo means MindfulTube is checking your writing.</h3>
              <p>
                When MindfulTube has a suggestion, you’ll see a number in the circle. When it’s the MindfulTube logo, it
                means MindfulTube has no suggestions.
              </p>
      ...
      <div className={s.w_extinfo}>
        To begin working with MindfulTube, click
