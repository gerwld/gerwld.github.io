  ...
  return (
    <div className={s.landing_content}>
      ...
      <div className={s.landing_wrapper}>
        <h1 className={s.landing_title}>EasyCalc Extension</h1>
        ...
        <nav className={s.download_links}>
          <a
            href="https://chrome.google.com/webstore/detail/EasyCalc-remove-instagra/dbbopjndlaginbghfoibbndhlbpdpapd"
            title="Google Chrome"
          >
