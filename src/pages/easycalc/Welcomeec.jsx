...
import logo from "@/assets/extensions/logo_easycalc.svg";
import slide_1 from "@/assets/extensions/shots/EasyCalc/prev_1.png";
  ...
  return (
    <div className={s.landing_content + " " + s.landing_content__welcome}>
      ...
      <div className={s.w_header}>
        <div className={s.w_header__content}>
          <div className={s.header_group}>
            <h1 className={s.landing_title}>EasyCalc for Chrome Is Now Active!</h1>
            <img class={s.logo} src={logo} alt="EasyCalc Extension" />
          </div>
          ...
          <div className={s.presentation}>
            ...
            <div className={s.pres_content}>
              <h3>The EasyCalc logo means EasyCalc is checking your writing.</h3>
              <p>
                When EasyCalc has a suggestion, you’ll see a number in the circle. When it’s the EasyCalc logo, it means
                EasyCalc has no suggestions.
              </p>
      ...
      <div className={s.w_body}>
        ...
        <p>Get suggestions from EasyCalc when you write on all your favorite platforms and devices.</p>

        <div className={s.ls_extensions}>
          {extensions_list
            .filter((e) => e.id !== "bqerne34dfbnddfbfsd4b5")
            .map((e) => (
      ...
      <div className={s.w_extinfo}>
        To begin working with EasyCalc, click
