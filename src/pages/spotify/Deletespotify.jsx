  ...
  return (
    <div className={s.landing_content}>
      ...
      <div className={s.un_content}>
        ...
        <p>Sorry to see you go! We're working to make InstaPlus the best it can be.</p>
        <form>
          <label>
            <span>Why did you uninstall InstaPlus?</span>
          ...
          <p>
            ...
            <a href="https://chrome.google.com/webstore/detail/instaplus-remove-instagra/dbbopjndlaginbghfoibbndhlbpdpapd">
              reinstall InstaPlus
            </a>
            .
          </p>
          <p>
            P.S. InstaPlus is customizable! Just tap <img src={logo} className={s.mini_ic} /> in the toolbar to choose
